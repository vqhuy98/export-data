...
public class TableExport {
  ...
  private static final String EXPORT_PATH = "/home/vqhuy01/idea/export-data-tran-lai/src/main/resources";
  ...
  private static void exportBlobColumn(ResultSet resultSet, ResultSetMetaData rsMetaData, int columnCount,
      File tableFolder) throws Exception {
    while (resultSet.next()) {
      for (int i = 1; i <= columnCount; i++) {
